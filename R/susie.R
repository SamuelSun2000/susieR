...
#'
#' @param eb_mix_pi1 Prior probability that a variant-level residual is
#'   generated by an unfitted sparse-signal component in the
#'   \code{R_mismatch = "eb_mix"} residual mixture gate. Default \code{1e-5};
#'   set to \code{0} to recover the ordinary \code{"eb"} correction.
#'
